 ...
 *
 * Esta interfaz define los métodos necesarios para enviar un mensaje de Sms utilizando la API de Twilio.
 *
...
interface SmsMessageSender
{
    ...
    /**
     * Establece el cuerpo del mensaje de Sms.
     *
    ...
    /**
     * Envía el mensaje de Sms al destinatario configurado.
     *
